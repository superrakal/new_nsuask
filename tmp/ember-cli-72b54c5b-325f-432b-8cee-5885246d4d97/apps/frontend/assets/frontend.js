  ...
  BesitController = Ember['default'].Controller.extend({
    actions: {
      "delete": function _delete(message) {
        return message.destroyRecord().then((function (_this) {
          return function () {
            return _this.transitionToRoute('besit');
          };
        })(this));
      }
    }
  ...
  LoveController = Ember['default'].Controller.extend({
    actions: {
      "delete": function _delete(message) {
        return message.destroyRecord().then((function (_this) {
          return function () {
            return _this.transitionToRoute('love');
          };
        })(this));
      }
    }
  ...
  OverhearController = Ember['default'].Controller.extend({
    actions: {
      "delete": function _delete(message) {
        return message.destroyRecord().then((function (_this) {
          return function () {
            return _this.transitionToRoute('overhear');
          };
        })(this));
      }
    }
...
define('frontend/controllers/sign-in', ['exports', 'ember', 'simple-auth/mixins/login-controller-mixin'], function (exports, Ember, LoginControllerMixin) {

  'use strict';

  var SignInController;

  SignInController = Ember['default'].Controller.extend(LoginControllerMixin['default'], {
    actions: {
...
define('frontend/helpers/inline-svg', ['exports', 'ember', 'frontend/svgs', 'ember-inline-svg/utils/general'], function (exports, Ember, SVGs, general) {
  ...
  function inlineSvg(path, options) {
    ...
    svg = general.applyClass(svg, options['class']);

    return new Ember['default'].Handlebars.SafeString(svg);
  }

  var helper = undefined;
  if (Ember['default'].Helper && Ember['default'].Helper.helper) {
    helper = Ember['default'].Helper.helper(function (_ref, options) {
    ...
    helper = Ember['default'].Handlebars.makeBoundHelper(function (path, options) {
...
define('frontend/svgs', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el6 = dom.createTextNode("NSUASK © 2016");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
...
define('frontend/templates/sign-in', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      statements: [
        ["inline","input",[],["type","email","placeholder","Логин","value",["subexpr","@mut",[["get","controller.identification",["loc",[null,[1,161],[1,186]]]]],[],[]],"class","form-control"],["loc",[null,[1,114],[1,209]]]],
        ["inline","input",[],["type","password","placeholder","Пароль","value",["subexpr","@mut",[["get","controller.password",["loc",[null,[1,290],[1,309]]]]],[],[]],"class","form-control"],["loc",[null,[1,239],[1,332]]]],
        ["element","action",["authenticate"],[],["loc",[null,[1,370],[1,395]]]]
      ],
      locals: [],
      templates: []
    };
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+5c4799a9"},"simple-auth-devise":{"serverTokenEndpoint":"/api/v1/authenticate"},"simple-auth":{"authorizer":"simple-auth-authorizer:devise","routeAfterAuthentication":"overhear"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+5c4799a9"});
}
